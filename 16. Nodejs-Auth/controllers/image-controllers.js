...
const uploadImageController = async(req, res)=> {
    try{
        ...
        // store the image url and public id along withe uploaded user id in the database
...
const deleteImageController = async(req, res)=>{
    try{
        ...
        //check if current user has rights to delete image
        ...
        //delete image from your cloudinary
